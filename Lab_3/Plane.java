...
count++;
    ...
    Plane(float engineCapacity, int peopleCap) throws FileNotFoundException {
        engine = new Engine(engineCapacity);
        strapMode = new StrapMode(peopleCap);
        wheels = new Wheels();
        PrintWriter fout = new PrintWriter(new File("Log.txt"));
     ...
     */
    public StrapMode getStrapMode() {
        return strapMode;
    }

    /* Setter for StrapMode
     */
    public void setStrapMode(StrapMode strapMode) {
